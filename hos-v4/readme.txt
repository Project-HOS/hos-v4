...
＜！注意！ CVSリポジトリ上から直接取得の方へ＞

  本ファイルは、リリースパッケージ作成の際の雛型とするための
ファイルです。
  リリースとして準備されていないファイルに関しては開発状況の
公開であり、リリース時にライセンス条項が改定される可能性が
あります。
  したがって、CVSリポジトリからの直接取得ファイルの再配布は
ご遠慮ください。

  以下、readme.txt の開発中の文面草案です。法的効力を持ちませんので
ご注意ください。
