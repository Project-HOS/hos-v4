...
#   ライブラリメイクファイル IA32 i386-elf-gcc用                              
#                                                                             
...
INCASMDIR  = $(HOSROOT)/include/ia32
SRCDIR     = $(HOSROOT)/src
PACDIR     = $(SRCDIR)/ia32
PACASMDIR  = $(PACDIR)/ia32gcc
MKNLDIR    = $(SRCDIR)/mknl
...
# オプション
CFLAGS = -c -g -Wall -O2 -I$(INCDIR) -pipe
AFLAGS = -c -g -I$(INCASMDIR)
...
# オブジェクトファイル
OBJS = pacctx.o pacent.o pacini.o pacint.o\
...
# プロセッサ依存
pacent.o: $(PACASMDIR)/pacent.S
	$(ASM) $(AFLAGS) -o pacent.o $(PACASMDIR)/pacent.S

pacini.o: $(PACDIR)/pacini.c
	$(CC) $(CFLAGS) -o pacini.o $(PACDIR)/pacini.c

pacctx.o: $(PACDIR)/pacctx.c
	$(CC) $(CFLAGS) -o pacctx.o $(PACDIR)/pacctx.c

pacint.o: $(PACDIR)/pacint.c
	$(CC) $(CFLAGS) -o pacint.o $(PACDIR)/pacint.c
