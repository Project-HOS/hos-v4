...
/*  Initialization Command Word 1  */
#define _PIC_ICW1_SENDICW4     0x01  /* ICW4を送信する */
#define _PIC_ICW1_SINGLPIC     0x02  /* PICが一つだけで構成されている */
#define _PIC_ICW1_CASCDPIC     0x00  /* 複数のPICがカスケード */
#define _PIC_ICW1_4BYTE        0x04  /* 割り込みベクタが4 byte */
#define _PIC_ICW1_8BYTE        0x00  /* 割り込みベクタが8 byte */
#define _PIC_ICW1_LELSENS      0x08  /* レベルセンシティブ */
#define _PIC_ICW1_EDGSEND      0x00  /* エッジセンシティブ */
...
#define PIC2_ICW1_CODE PIC1_ICW1_CODE  /*  同じコード  */
