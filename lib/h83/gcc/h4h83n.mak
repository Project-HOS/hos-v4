...
# オプション
CFLAGS = -c -mh -mn -O2 -fomit-frame-pointer -I$(INCDIR) -pipe
AFLAGS = -c -mh -mn -pipe
LFLAGS =
...
pacctx.o: $(PACDIR)/gcc/pacctxn.S
	$(ASM) $(AFLAGS) $(PACDIR)/gcc/pacctxn.S -o pacctx.o

pacint.o: $(PACDIR)/gcc/pacintn.S
	$(ASM) $(AFLAGS) $(PACDIR)/gcc/pacintn.S -o pacint.o
